...
## Как я создаю AI-продукты

**AI-продукты end-to-end.** Иду от постановки задачи и ML-гипотез до модели, API, интерфейса, воспроизводимого запуска и готового продукта.

**ML, который работает в приложении.** Не ограничиваюсь ноутбуком: упаковываю решения в сервисы, demo-flow, Docker/CI и понятный пользовательский сценарий.

**CV, NLP и LLM на реальных задачах.** Люблю проекты, где нужно разобраться в домене, данных и найти нестандартный технический ход.

**AI-инструменты в разработке.** Использую Cursor, ChatGPT, n8n, Kaggle и Colab для исследования, прототипирования и ускорения разработки.

**Быстрый MVP и защита решения.** Умею за короткое время собрать рабочий продукт, показать его ценность и подготовить сильную презентацию.
